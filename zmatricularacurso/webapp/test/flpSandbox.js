		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Matricular a Curso",
									"targetURL": "#nebulacomzmatricularacurso-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nebulacomzmatricularacurso-display": {
								"semanticObject": "nebulacomzmatricularacurso",
								"action": "display",
								"description": "Modulo para matriculas a cursos",
								"title": "Matricular a Curso",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nebula.com.zmatricularacurso",
									"url": sap.ui.require.toUrl("nebula/com/zmatricularacurso")
								}
							}
						}
					}
